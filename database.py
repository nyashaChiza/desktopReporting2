...
def _createTables(con):
    ...
    con.execute("CREATE TABLE IF NOT EXISTS A_I( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,sin TEXT,gender TEXT,first_name TEXT,last_name TEXT, last_name_prefix TEXT,academic_title TEXT,filler1 TEXT,birth_date DATE, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS J_S( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,country_code TEXT,postal_code TEXT,city TEXT,c_o TEXT, filler2 TEXT,filler3 TEXT,filler4 TEXT,country_code_mail_address TEXT, postal_code_mail_address TEXT,city_mail_address TEXT,date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS T_AC( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,date_of_entry_into_group TEXT,date_of_leaving_group TEXT,reason_for_leaving_the_group TEXT,bank_code TEXT, bank_account_number TEXT,swift_bic TEXT,owner_of_bank_account TEXT,employee_with_potential DATE,indicator_for_executive TEXT,indicator_for_security_advisor TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS AD_AN( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,indicator_eligibility_stock_purchase_program TEXT,company_code TEXT,personal_number TEXT,plant_identifier_for_personal_number TEXT, filler5 TEXT,filler6 TEXT,transfer_date TEXT,filler7 TEXT,filler8 TEXT,local_cost_center TEXT, date_entry DATE DEFAULT today )")
    
    con.execute("CREATE TABLE IF NOT EXISTS AM_AW( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,employee_group TEXT,filler9 TEXT,department_abbreviation TEXT,hr_executive_level TEXT, employment_type TEXT,organizational_code TEXT,physical_work_location_code TEXT,internal_mail_code TEXT,level_of_business_allocation1 TEXT,level_of_business_allocation2 TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS AX_BG( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,mailing_language_of_employee TEXT,building TEXT,room_number TEXT,location_code TEXT, country_of_birth TEXT,city_of_birth TEXT,citizenship TEXT,filler10 TEXT,filler11 TEXT,street_and_house_number_of_home_address TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS BH_BQ( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,street_and_house_number_for_preferred_mailing_address TEXT,filler12 TEXT,job_code TEXT,plant2 TEXT, plant1 TEXT,organizational_code2 TEXT,smtp_email_address TEXT,position_entry_date TEXT,date_contract_end TEXT,hr_department TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS BR_CA( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,hr_representative TEXT,fax_number_hr_representative TEXT,management_level TEXT,work_phone_number_of_hr_representative TEXT, preferred_first_name TEXT,middle_initial TEXT,home_host_indicator TEXT,fulltime_parttime_equivalency TEXT,reports_to_kim TEXT,date_of_entry_into_company TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS CB_CW( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,filler12 TEXT,filler13 TEXT,filler14 TEXT, filler15 TEXT,filler16 TEXT,filler17 TEXT,filler18 TEXT,filler19 TEXT,filler20 TEXT,filler21 TEXT,filler22 TEXT, filler23 TEXT,filler24 TEXT,filler25 TEXT,filler26 TEXT,filler27 TEXT,filler28 TEXT,filler29 TEXT,filler30 TEXT,filler31 TEXT,filler32 TEXT,filler33 TEXT, date_entry DATE DEFAULT today )")                 

    con.execute("CREATE TABLE IF NOT EXISTS CX_DG( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,current_position_title TEXT,payment_type TEXT,plant_section TEXT,filler35 TEXT, indicator_for_disabled_person TEXT,social_security_number TEXT,state TEXT,state_for_preferred_mailing_address TEXT,phone_country_code TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS DH_DQ( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,phone_country_code TEXT,phone_extension_and_company TEXT,fax_country_code TEXT,fax_area_code TEXT, fax_extension_and_company TEXT,mobile_country_code TEXT,mobile_area_code TEXT,mobile_number TEXT,empl_id TEXT,filler36 TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS DR_EA( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,filler37 TEXT,bv_wechsel_ab TEXT,wohnhaft_bei TEXT,company_code_expat TEXT, currency TEXT,filler38 TEXT,year_of_goal_income TEXT,monthly_salary TEXT,delete_flag TEXT,filler39 TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS EB_EK( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,grade_band TEXT,shift_indicator TEXT,employee_category TEXT,department_name TEXT, status_employee TEXT,code_dl_tv TEXT,grade TEXT,nacos_cost_center TEXT,wage_group TEXT,year_of_wage_group TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS EL_EY( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,date_of_assignment_to_wage_group TEXT,filler40 TEXT,logon_id_of_employee TEXT,company_name_of_external_person TEXT, filler41 TEXT,filler42 TEXT,filler43 TEXT,filler44 TEXT,filler45 TEXT,filler46 TEXT,filler47 TEXT,filler48 TEXT,filler49 TEXT,filler50 TEXT, date_entry DATE DEFAULT today )")

    con.execute("CREATE TABLE IF NOT EXISTS EZ_FI( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,bv_wechsel_ab TEXT,filler51 TEXT,filler52 TEXT,type_of_timeframe_for_tax_data TEXT, starting_of_timeframe_for_tax_data TEXT,end_of_timeframe_for_tax_data TEXT,type_of_timeframe_for_tax_data2 TEXT, starting_of_timeframe_for_tax_data2 TEXT,end_of_timeframe_for_tax_data2 TEXT, type_of_timeframe_for_tax_data3 TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS FJ_FS( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,starting_of_timeframe_for_tax_data TEXT,end_of_timeframe_for_tax_data TEXT, type_of_timeframe_for_tax_data TEXT, starting_of_timeframe_for_tax_data2 TEXT,end_of_timeframe_for_tax_data2 TEXT, type_of_timeframe_for_tax_data2 TEXT ,starting_of_timeframe_for_tax_data3 TEXT,end_of_timeframe_for_tax_data3 TEXT, type_of_timeframe_for_tax_data3 TEXT,starting_of_timeframe_for_tax_data4 TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS FT_GC( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,end_of_timeframe_for_tax_data TEXT,type_of_timeframe_for_tax_data TEXT,starting_of_timeframe_for_tax_data TEXT,end_of_timeframe_for_tax_data2 TEXT,type_of_timeframe_for_tax_data2 TEXT,starting_of_timeframe_for_tax_data2 TEXT,end_of_timeframe_for_tax_data3 TEXT,type_of_timeframe_for_tax_data3 TEXT,starting_of_timeframe_for_tax_data3 TEXT,end_of_timeframe_for_tax_data4 TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS GD_GM( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,type_of_timeframe_for_tax_data TEXT,starting_of_timeframe_for_tax_data TEXT,end_of_timeframe_for_tax_data TEXT,type_of_timeframe_for_tax_data2 TEXT,starting_of_timeframe_for_tax_data2 TEXT,end_of_timeframe_for_tax_data2 TEXT,type_of_timeframe_for_tax_data3 TEXT,starting_of_timeframe_for_tax_data3 TEXT,end_of_timeframe_for_tax_data3 TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS GN_GW( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,permanent_residence TEXT,filler54 TEXT,wage_and_salary_group TEXT,diversity TEXT, executive_bonus TEXT,number_of_monthly_base_salary TEXT,structure_code TEXT,dept_id TEXT,full_time_equivalent TEXT,bonus_payout TEXT, date_entry DATE DEFAULT today )")
    con.execute("CREATE TABLE IF NOT EXISTS GX_HK( id INTEGER PRIMARY KEY AUTOINCREMENT ,kim TEXT UNIQUE,position_control_number TEXT,daimler_cost_center TEXT,last_name_passport TEXT,first_name_passport TEXT, executive_bonus TEXT,iban TEXT,local_job_profile TEXT,irwwh TEXT,buchungskreis TEXT,rabattkennzeichen TEXT,valid_by TEXT,widersprecherkennzeichen TEXT,ivv_contract TEXT,ivv_risk_taker TEXT,ivv_control_unit TEXT, date_entry DATE DEFAULT today )")
    con.close()
#-----------------------------------------------------------------------------------------------------------------------------------
def updateInfo(data):
